            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16 sm:h-20">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4 flex-1 min-w-0">
                        <Link to="/" className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
                            <img
                                ...
                                onError={(e) => {
                                    e.target.src = 'https://via.placeholder.com/120x40/f97316/ffffff?text=Swiggy'
                                }}
                            />
                        </Link>
                        <div className="hidden md:block min-w-0 flex-1">
                            <div className="flex items-center space-x-2 text-gray-700">
                                <span className="font-bold text-base lg:text-lg">HOME</span>
                                <span className="text-xs lg:text-sm text-gray-500 truncate">
                                    JSS Boys Hostel, Near Petrol Pump, Srinivaspura
                                </span>
                    ...
                    <div className="hidden md:flex items-center space-x-4 lg:space-x-8">
                        <div className="hidden lg:flex items-center space-x-2 text-gray-700 hover:text-orange-500 cursor-pointer">
                        ...
                        <div className="flex items-center space-x-2 text-gray-700 hover:text-orange-500 cursor-pointer relative">
                            ...
                            <span className="hidden lg:inline text-sm font-medium">Offers</span>
                    ...
                    <div className="md:hidden border-t border-gray-200 py-4">
                        <div className="space-y-4">
                            <div className="text-gray-700 text-sm">
                                ...
                                <p className="text-xs text-gray-500 mt-1">JSS Boys Hostel, Near Petrol Pump, Srinivaspura</p>
                            </div>

                            <Link to="/orders" className="flex items-center space-x-3 text-gray-700 hover:text-orange-500">
                            ...
                            <Link to="/create-bill" className="flex items-center space-x-3 text-gray-700 hover:text-orange-500">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                                </svg>
